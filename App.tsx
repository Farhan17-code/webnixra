          ...
          <div className="grid md:grid-cols-3 gap-8">
            {TEAM_MEMBERS.map((member) => (
              <div key={member.id} className="group relative glass rounded-[2rem] p-8 hover:bg-white/[0.05] transition-all duration-500 border-white/5">
                <div className="relative w-24 h-24 mb-6 rounded-2xl overflow-hidden">
                  <img 
                    src={member.imageUrl} 
                    alt={member.name} 
      ...
      <section id="projects" className="py-24 px-6">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            ...
            <a href="#" className="hidden md:flex items-center space-x-2 text-white font-semibold group mt-6 md:mt-0">
      ...
      <footer className="py-20 border-t border-white/5">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex justify-center space-x-10 text-gray-500">
            <a href="#" className="hover:text-blue-500 transition-colors"><Github size={22} /></a>
            <a href="#" className="hover:text-blue-500 transition-colors"><Linkedin size={22} /></a>
            <a href="#" className="hover:text-blue-500 transition-colors"><Twitter size={22} /></a>
          </div>
        </div>
      </footer>
